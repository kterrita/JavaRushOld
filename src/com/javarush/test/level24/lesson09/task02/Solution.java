    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                double c1 =stock1.containsKey("open")?(double)stock1.get("open")-(double)stock1.get("last"):(double)stock1.get("change");
                double c2 =stock2.containsKey("open")?(double)stock2.get("open")-(double)stock2.get("last"):(double)stock2.get("change");
                cashDiff = Double.compare(c1,c2);

                if (nameDiff!=0)return nameDiff;else
                if (dateDiff!=0)return dateDiff;else
